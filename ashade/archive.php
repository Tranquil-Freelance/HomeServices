			...
			<div class="ashade-content">
				<div class="ashade-row <?php echo ( 'left' == $ashade_sidebar ? 'is-reverse' : '' ); ?>">
					<div class="ashade-col col-<?php echo ( 'none' == $ashade_sidebar ? '12' : '9' ); ?>">
						<div class="ashade-blog-listing <?php echo esc_attr($post_type == 'ashade-albums' ? 'ashade-albums-archive' : ''); ?>">
						<?php
						if ( have_posts() ) :
							/* Start the Loop */
							while ( have_posts() ) :
								...
								if ( $post_type !== 'ashade-albums' ) {
									...
									get_template_part( 'template-parts/albums-listing' );
								}
