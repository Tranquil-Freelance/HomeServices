...
let ashade_slider = {
	...
	init: function() {
		...
		if ( ! ashade_slider.is_single ) {
			...
			ashade_slider.$el.on('mousedown', function(e) {
                ...
                ashade_slider.isDownLink = false;
				ashade_slider.action.dragBreak();
                ashade_slider.$el.removeClass('is-moving');
				...
				if (ashade_slider.isDown) {
                    ashade_slider.$el.addClass('is-moving');
					if (ashade_slider.type == 'fade') {
						// Fade Movement
                ...
                if (ashade_slider.isDownLink) {
                    ashade_slider.isLinkMoved = true;
                } else {
                    ashade_slider.isLinkMoved = false;
                }
			});
            ...
            // Bind Link Event
            ashade_slider.$el.find('a.ashade-slider-link').on('mousedown', function() {
                ashade_slider.isDownLink = true;
            }).on('click', function(e) {
                if (ashade_slider.isLinkMoved) {
                    e.preventDefault();
                    return false;
                }
                ashade_slider.isDownLink = false;
	...
	action: {
		...
		set : function() {
            ...
            ashade_slider.$el.addClass('is-animate');
			...
			if (ashade_slider.type == 'fade') {
				...
				},
				{
					...
					onComplete: function() {
                        ...
                        ashade_slider.$el.removeClass('is-animate');
					}
				});
