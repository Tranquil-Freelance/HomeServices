			...
			<div class="ashade-content">
				<div class="ashade-row <?php echo ( 'left' == $ashade_sidebar ? 'is-reverse' : '' ); ?>">
					<div class="ashade-col col-<?php echo ( 'none' == $ashade_sidebar ? '12' : '9' ); ?>">
						<div class="ashade-search-listing">
						<?php
						if ( have_posts() ) :
							/* Start the Loop */
							while ( have_posts() ) :
							...
							echo '<p class="ashade-nothing-found">'. esc_html__( 'There is nothing found according to your query ', 'ashade' ) . '<span>"' . esc_html( get_search_query() ) . '"</span>' .'</p>';
