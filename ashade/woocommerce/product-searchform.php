...
?>
<form role="search" method="get" class="woocommerce-product-search ashade-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<input type="search" id="woocommerce-product-search-field-<?php echo isset( $index ) ? absint( $index ) : 0; ?>" class="search-field" placeholder="<?php echo esc_attr__( 'Search products&hellip;', 'ashade' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
	...
	<button type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'ashade' ); ?>"><?php echo esc_html_x( 'Search', 'submit button', 'ashade' ); ?></button>
